...
//Adicionar IMG em telas de celular.
    enquire.register("(max-width: 361px)",{
        ...
        match : function (){
            ...
            //Edit IMG and add class to new DIV
            nodeDiv.id = "cel-img";
            nodeDiv.classList.add("promo");
            nodeImg.classList.add("img-fluid");
            nodeImg.src = "https://via.placeholder.com/540x1200";

            nodeDiv.appendChild(nodeImg);
            
            element.insertBefore(nodeDiv, child);

            child.classList.remove("m-3");
        ...
        unmatch: function(){
            parent = document.getElementById("caixa");
            bastard = document.getElementById("cel-img");
            //Remove landscape IMG and change to a smaller version.
            if(bastard !== null){
                parent.removeChild(bastard);
            }
            var div = document.getElementById("formulario");

            div.classList.remove("m-3");
...
// Desktop
    enquire.register("(max-width: 1200px)",{
        //Triggered when media query matches.
        match : function (){
            var nodeDiv = document.createElement("div");
            var nodeImg = document.createElement("img");
